...
const canViewOrganizationGrid = requireRole(viewOrganization);
...
const HierarchyRouter = ({ match }) => (
    <SwitchWithNotFound>
        ...
        <Route path={`${match.url}/subdepartments/:subDepartment/team/employee/:id`} exact component={canViewTeamGrid(EmployeeDetails)} />
        ...
        <Route path={`${match.url}/organizations`} component={canViewOrganizationGrid(OrganizationList)} />
    </SwitchWithNotFound>
);
