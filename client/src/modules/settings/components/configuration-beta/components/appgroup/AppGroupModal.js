...
class AppGroupModal extends Component {
    ...
    buildForm = () => {
        ...
        const fields = [{
            ...
            label: 'Group Users',
            model: 'AppUser',
            filter: { 'appId': 'APP-00000004', 'status': 'active' },
            displayKey: 'email',
            valueKey: 'email'
        }];
    ...
    onClickSave = () => {
        ...
        if (formValues) {
            ...
            try {
                ...
                const uri = actionType === "CREATE" ? `/usermanagement/v1/config/appgroup` : `/usermanagement/v1/config/appgroup/${get(appGroupData, 'formattedName')}`;
