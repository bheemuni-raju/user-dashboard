...
const AppRoleRouter = ({ match }) =>
    <SwitchWithNotFound>
        ...
        <Route path={`${match.url}/:formattedName/edit`} exact component={canEditAppRole(AppRoleEdit)} />
        <Route path={`${match.url}/:formattedName/clone`} exact component={canCloneAppRole(AppRoleClone)} />
    </SwitchWithNotFound>
