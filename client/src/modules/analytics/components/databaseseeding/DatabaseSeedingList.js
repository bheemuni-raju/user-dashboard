    ...
    return (
        <Box>
            <BoxBody loading={loading} error={error}>
                <ByjusGrid
                    isKey="_id"
                    gridId="ums_database_seeding_grid"
                    ref={byjusGridRef}
                    formatters={formatters()}
                    gridDataUrl="/usermanagement/analyticsmanagement/databaseseeding/list"
                />
            </BoxBody>
        </Box>
    )
...
export default DataSeedingList;
