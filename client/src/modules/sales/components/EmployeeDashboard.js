...
class EmployeeDashboard extends Component {
    ...
    render() {
        ...
        tabs.push({
            ...
            title: "All",
            component: <EmployeeList department={subDepartments[0] ? subDepartments[0].department : ""} subDepartment={null} />
        });
        ...
        if (subDepartments.length > 0) {
            ...
            subDepartments.forEach(subDepartment => {
                ...
                tabs.push({
                    ...
                    component: <EmployeeList subDepartment={subDepartment} roles={hierarchyRoles} />
                })
            })
        }
