...
const Toolbar = (props) => {
    const { pillOptions, addOnQfColumns, functions = {}, gridTitle, modelName, gridId, columns, dbName } = props;
    ...
    const applyQuickFilter = (columnField, searchText) => {
        ...
        if (searchValues.length > 0) {
            searchBuilder = [{
                ...
                selectedOperator: searchValues.length == 1 ? "contains" : "in",
                    ...
                    <>
                        ...
                        <Dropdown isOpen={tbDropdownOpen} toggle={toggleTbDropdown} className="d-inline-block ml-2">
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownItem onClick={functions.showAdvanceSearch}>
                                    <i className="fa fa-search-plus" /> Advance Search
                            </DropdownItem>
                                <DropdownItem onClick={functions.clearAdvanceSearch}>
