...
class AttendanceEditModal extends React.Component {
  constructor(props) {
    ...
    const {workflowStatus, emailId, date, meetingAttendanceStatus, talktime, connectedCalls, finalAttendance, reportingManagerEmailId, leaveType} = props.rowData;
    ...
    let fields = [
      ...
      },
      {
        ...
        options: [
            ...
            {label:"Compensatory Off" , value:"compensatory_off"},
            {label:"Optional Holiday" , value:"optional_holiday"},
            {label:"Casual Leave / Sick Leave" , value:"casualLeave_or_sickLeave"},
        ]
      },
    ];
    return fields;
