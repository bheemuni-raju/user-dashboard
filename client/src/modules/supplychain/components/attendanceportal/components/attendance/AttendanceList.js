...
const AttendanceList = (props) => {
    ...
    const baseUrl = `/usermanagement/supplychain/attendance/list`;
    ...
    const handleFromSubmit = (formData) => {
        ...
        callApi(`/usermanagement/supplychain/attendance/updateAttendance`, 'PUT', formData, null, null, true)
            .then((response) => {
                closeModal();
    ...
    const getColumns = () => {
        const columns = [{
            ...
            dataField: 'reportingManagerRole',
            text: 'TM Role',
            quickFilter: true
        }, {
            ...
            dataField: 'agentRequest.workflowStatus',
            text: 'Agent WorkFlow Status',
            quickFilter: true
        }, {
            dataField: 'agentRequest.reason',
            text: 'Agent Request Reason',
            quickFilter: true
        }, {
    ...
    const getPills = () => {
        return [{
            ...
            title: 'ADO',
            contextCriterias: [{
                selectedColumn: 'agentRequest.workflowStatus',
                selectedOperator: 'in',
                selectedValue: ['agent_dispute_open']
            }]
        }, {
            title: 'ARR',
            contextCriterias: [{
    ...
    const getSearchFields = () => {
        return [{
            ...
            name: "email",
            model: "ScEmployee",
            filter: { subDepartment: "digital_finance", role: "team_manager" },
    ...
    const handleUpdateAttendanceStatusFromSubmit = (formData) => {
        ...
        callApi(`/usermanagement/supplychain/attendance/updateMeetingAttendanceStatus`, 'PUT', formData, null, null, true)
            .then((response) => {
